...
export default function RelatorioMensal({ currentUser, logout, perfilPontos }) {
      ...
      <main className="report-content">
        <div className="report-header">
          <div className="report-title-area">
            ...
            <h1 className="pixel-text report-title">RELATÓRIO MENSAL</h1>
          </div>
          <button className="toggle-btn" onClick={() => navigate('/semanal')} title="Relatório anterior (Semanal)">
        ...
        {!loading && !erro && dados && (
          <>
            ...
            <section className="report-section">
              <h2 className="pixel-text section-title">PONTOS — ESTE MÊS VS. MÊS PASSADO</h2>
              <BarChart data={dados.chartData} direction="horizontal" />
            </section>

            <section className="report-section">
              <h2 className="pixel-text section-title">ATIVIDADES ESTE MÊS</h2>
